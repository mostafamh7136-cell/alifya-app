...
// Curated human recordings for formal/standard Arabic. Dialect-labelled files are deliberately excluded.
// The lookup is local and deterministic: no runtime speech synthesis and no runtime dialect discovery.
...
const findVerifiedMsaAudio = async (text: string): Promise<string | null> => {
  // Do not perform an unverified remote search here. Every playable source must be explicitly curated.
  return VERIFIED_MSA_AUDIO[normalize(text)] ?? null;
};
